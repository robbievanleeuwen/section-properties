...
# def tee_wall() -> geometry.CompoundGeometry:

# def single_lift_core() -> geometry.CompoundGeometry:

# def double_lift_core_a() -> geometry.CompoundGeometry:

# def double_lift_core_b() -> geometry.CompoundGeometry:
