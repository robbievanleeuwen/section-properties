...
class triMesh:
    ...
    def __init__(self, genMesh, nu=0, geometricMesh=None):
        ...
        the poisson's ratio (nu) and optionally a triMesh object (geometricMesh)
        containing geometric section properties results.
        '''
    ...
    def computePrincipalPlasticProperties(self, points, facets, holes):
        ...
        (bc1_1, bc1_2) = (principalCoordinate(self.phi,
            botCentroid1[0] - self.cx, botCentroid1[1] - self.cy))
        (tc2_1, tc2_2) = (principalCoordinate(self.phi,
            topCentroid2[0] - self.cx, topCentroid2[1] - self.cy))
        (bc2_1, bc2_2) = (principalCoordinate(self.phi,
    ...
    def computeWarpingProperties(self, output=True):
        ...
        (self.x_1_se, self.y_2_se) = (principalCoordinate(phi,
            self.x_se, self.y_se))
        ...
        # calculate the shear coefficients (alpha) forming a second order tensor
    ...
    def invertStiffnessMatrix(self, K):
        '''
        This function inverts a stiffness matrix using the Lagrangian Multiplier
        method.
        '''
...
def pcAlgorithm(tol, maxIt, u, cx, cy, dmin, dmax, points, facets, holes,
    ...
    while ((abs(areaConvergence_n) > tol or iterationCount < 3) and
        ...
        (points_new, facets_new) = (divideMesh(points[:],
