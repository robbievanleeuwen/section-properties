...
:class:`~sectionproperties.analysis.cross_section.Section` object. This class
...
..  automethod:: sectionproperties.analysis.cross_section.Section.display_mesh_info
    :noindex:

..  automethod:: sectionproperties.analysis.cross_section.Section.plot_mesh
    :noindex:
...
..  automethod:: sectionproperties.analysis.cross_section.Section.calculate_geometric_properties
    :noindex:
...
..  automethod:: sectionproperties.analysis.cross_section.Section.calculate_plastic_properties
    :noindex:
...
..  automethod:: sectionproperties.analysis.cross_section.Section.calculate_warping_properties
    :noindex:
...
..  automethod:: sectionproperties.analysis.cross_section.Section.calculate_stress
    :noindex:
...
..  automethod:: sectionproperties.analysis.cross_section.Section.calculate_frame_properties
    :noindex:
